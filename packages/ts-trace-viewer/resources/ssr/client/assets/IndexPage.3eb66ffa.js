import { u as useDarkProps, a as useDark, c as clearSelection, m as getScrollbarWidth, b as useModelToggleProps, s as scrollTargetProp, d as useModelToggleEmits, e as useTimeout, f as useModelToggle, j as getScrollTarget, g as useHistory, i as usePreventScroll, q as normalizeToInterval, Q as QItemLabel, o as QItem, n as appState, t as trpc } from "./appState.0fad96f1.js";
import { c as createComponent, a as computed, h, g as getCurrentInstance, f as inject, j as emptyRenderFn, k as layoutKey, C as pageContainerKey, i as isRuntimeSsrPreHydration, r as ref, o as onMounted, w as watch, W as onBeforeUpdate, d as onBeforeUnmount, X as formKey, Y as debounce, Z as injectProp, z as stopAndPrevent, e as nextTick, U as onDeactivated, _ as onActivated, u as prevent, T as Transition, Q as isKeyCode, s as addEvt, y as cleanEvt, l as listenOpts, $ as globalConfig, E as onUnmounted, a0 as Teleport, p as client, x as position, a1 as onBeforeMount, a2 as onUpdated, a3 as isDeepEqual, v as stop, a4 as shouldIgnoreKey, F as defineComponent, G as openBlock, K as createBlock, L as withCtx, N as createBaseVNode, M as createTextVNode, O as toDisplayString, H as createElementBlock, a5 as renderList, a6 as createCommentVNode, a7 as Fragment, I as createVNode, P as unref } from "./index.b3b08812.js";
import { h as hSlot, Q as QIcon, g as QSpinner, u as useSizeProps, e as useSize, b as hDir, m as hMergeSlotSafely, R as Ripple, n as getParentProxy, l as vmIsDestroyed, o as childHasFocus, c as hMergeSlot } from "./use-router-link.cfd28949.js";
...
const _sfc_main$2 = defineComponent({
  ...
  setup(__props) {
    ...
    const types = computed(
      () => {
        var _a;
        return ((_a = appState.data) != null ? _a : []).filter(
...
const _sfc_main$1 = defineComponent({
  ...
  setup(__props) {
    ...
    const selectedLines = computed(
      () => {
        var _a;
        return (_a = appState.data) == null ? void 0 : _a.filter(
          (x) => {
            var _a2;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        ...
        createBaseVNode("div", _hoisted_1$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(selectedLines.value, (line) => {
            return openBlock(), createElementBlock("div", {
              key: line.ts
            }, [
              createVNode(QCard, {
...
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("pre", null, null, -1);
const _sfc_main = defineComponent({
  __name: "IndexPage",
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(QPage, { class: "row items-evenly justify-start" }, {
        default: withCtx(() => [
          createVNode(QCard, {
            style: { "width": "100%" },
            class: "q-pa-sm dark"
