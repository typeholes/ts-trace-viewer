...
import { c as createComponent, a as computed, h, r as ref, S as isKeyCode, z as stopAndPrevent, g as getCurrentInstance, d as onBeforeUnmount, U as History, w as watch, o as onMounted, e as nextTick, p as client, l as listenOpts, V as getEventPath, W as onDeactivated, X as Platform, D as reactive } from "./index.354d01ba.js";
import { h as hSlot, u as useRouterLinkProps, d as useRouterLink, a as hUniqueSlot, v as vmHasRouter, g as getElement, e as css, f as vmIsDestroyed } from "./QBtn.62120c33.js";
...
const trpc = mkTrpc((_h = (_g = globalThis == null ? void 0 : globalThis.location) == null ? void 0 : _g.port) != null ? _h : "3000");
const _appState = {
  ...
  trpc.clearWarnings.query().then(() => {
    trpc.durationWarning.query().then((limit) => {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        if (line.dur && line.dur > limit && ((_a2 = line.args) == null ? void 0 : _a2.path) && ((_b2 = line.args) == null ? void 0 : _b2.pos) && ((_c2 = line.args) == null ? void 0 : _c2.end)) {
